...
(function ($, document, window, undefined) {
  ...
  $.fn.pagepiling = function (custom) {
    ...
    $.extend($.easing,{ easeInQuart: function (x, t, b, c, d) { return c*(t/=d)*t*t*t + b; }});
       ...
       */
        PP.moveSectionUp = function () {
            var prev = $('.pp-section.active-horizontal').prev('.pp-section');
    ...
    PP.moveSectionDown = function () {
      var next = $('.pp-section.active-horizontal').next('.pp-section');
       ...
       */
        PP.moveToHorizontal = function (section){
            var destiny = '';
    ...
    $('.pp-section').each(function (index) {
      ...
      if (!index && $('.pp-section.active-horizontal').length === 0) {
        $(this).addClass('active-horizontal');
      }
      ...
      if(options.navigation){
        ...
        $('#pp-nav').find('li').eq($('.pp-section.active-horizontal').index('.pp-section')).find('a').addClass('active-horizontal');
      }
      ...
      $.isFunction( options.afterRender ) && options.afterRender.call( this);
          ...
          function getYmovement(destiny){
            var fromIndex = $('.pp-section.active-horizontal').index('.pp-section');
          ...
          function scrollPage(destination, animated) {
            var v ={
              ...
              animated: animated,
              activeSection: $('.pp-section.active-horizontal'),
              anchorLink: destination.data('anchor'),
              sectionIndex: destination.index('.pp-section'),
              toMove: destination,
              yMovement: getYmovement(destination),
              leavingSection: $('.pp-section.active-horizontal').index('.pp-section') + 1
            };
            ...
            v.destination.addClass('active-horizontal').siblings().removeClass('active-horizontal');
              ...
              if(options.keyboardScrolling && !isMoving() && $('#who-am-i').visible()){
                ...
                switch (e.which) {
                  ...
                  case 34:
                    ...
                    //Home
                  case 36:
                    PP.moveToHorizontal(1);
                    break;

                    //End
                  case 35:
                    PP.moveToHorizontal($('.pp-section').length);
                    break;
 ...
 */
        function activateNavDots(name, sectionIndex){
            if(options.navigation){
                $('#pp-nav').find('.active-horizontal').removeClass('active-horizontal');
                if(name){
                    $('#pp-nav').find('a[href="#' + name + '"]').addClass('active-horizontal');
                }else{
                    $('#pp-nav').find('li').eq(sectionIndex).find('a').addClass('active-horizontal');
                }
            }
        }
 ...
 */
        function activateMenuElement(name){
            if(options.menu){
                $(options.menu).find('.active-horizontal').removeClass('active-horizontal');
                $(options.menu).find('[data-menuanchor="'+name+'"]').addClass('active-horizontal');
            }
        }
